...
const Signup = () => {
    ...
    return (
        <>
            <Link to="/login" className="btn btn-link text-slate-400 no-underline font-bold mt-4 ms-4">← Back</Link>
            <div className="flex min-h-full flex-col justify-center px-6 py-12 lg:px-8">
                <div className="sm:mx-auto sm:w-full sm:max-w-sm">
                    ...
                    <h2 className="mt-10 text-center text-4xl font-bold tracking-tight text-gray-700">Signup</h2>
                </div>
                ...
                <div className="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
                    <form action="" onSubmit={(e) => e.preventDefault()} className="space-y-6">
                        ...
                        <div>
                            <button type="submit" className="flex w-full justify-center rounded-md bg-indigo-500 px-3 py-1.5 text-sm/6 font-semibold text-white hover:bg-indigo-400 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-500" onClick={submitForm}>Sign up</button>
                        </div>
                    </form>
